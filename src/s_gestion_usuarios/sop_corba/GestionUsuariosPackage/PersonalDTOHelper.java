...
/**
* s_gestion_usuarios/sop_corba/GestionUsuariosPackage/PersonalDTOHelper.java .
...
abstract public class PersonalDTOHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (s_gestion_usuarios.sop_corba.GestionUsuariosPackage.PersonalDTOHelper.id (), "PersonalDTO", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    s_gestion_usuarios.sop_corba.GestionUsuariosPackage.PersonalDTO value = new s_gestion_usuarios.sop_corba.GestionUsuariosPackage.PersonalDTO ();
